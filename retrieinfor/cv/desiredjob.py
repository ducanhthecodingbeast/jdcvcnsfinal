"""
Extract desired job position from CV data using QA model.
...
def extract_desired_job(desired_job_text: str) -> str:
    """
    Extract desired job position from CV.
    ...
    questions = [
        "Người này đang tìm kiếm vị trí công việc nào?",
        "Vị trí công việc mong muốn là gì?",
        "Vai trò mà ứng viên muốn ứng tuyển là gì?",
        "Người này đang tìm kiếm loại công việc gì?"
    ]
