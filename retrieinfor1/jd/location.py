"""
Extract job location from JD data using embedding similarity.
...
def extract_job_location(job_address: str) -> str:
    """
    Extract job location from JD using embedding similarity.
    ...
    result = extract_field_by_similarity(context, "job_location")
