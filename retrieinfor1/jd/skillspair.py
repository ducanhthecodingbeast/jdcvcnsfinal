"""
Extract required skills from JD data using embedding similarity.
...
def extract_required_skills(job_req: str, job_desc: str = "") -> str:
    """
    Extract required skills from JD using embedding similarity.
    ...
    return extract_field_by_similarity(context, "required_skills")
